...
urlpatterns = [
    path('api/radius/<str:scoreCategory>/<str:initialAddress>/<str:radiusValue>/<str:minPopulation>', views.recommendCity),
    path('api/radius/<str:scoreCategory>/<str:initialAddress>/<str:radiusValue>/<str:minPopulation>/<str:maxPopulation>', views.recommendCity),
    path('api/radius/<str:scoreCategory>/<str:initialAddress>/<str:radiusValue>', views.recommendCity),
